...
import java.util.stream.Collectors;
    ...
    public class AddressBook {
		 ...
		 */
            ...
            Comparator<ContactInfo> compareFirstName=Comparator.comparing(ContactInfo::getFirstName);//first name comparator
        ...
        public void sortPersonByPin(){
            ...
            Comparator<ContactInfo> comparePostal=Comparator.comparing(ContactInfo::getZip);//Zip comparator
